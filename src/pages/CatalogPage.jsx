        ...
        async function loadCoffees() {
            ...
            try {
                const response = await getCoffees({
                    ...
                    roastLevel:
                        queryFilters.roastLevel === 'all'
                            ? undefined
                            : queryFilters.roastLevel,
                    available:
                        queryFilters.available === 'all'
                            ? undefined
                            : queryFilters.available,
                    page: 1,
                    limit: 12,
                });
                ...
                <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
                    <div>
                        ...
                        <h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-tight text-stone-950 sm:text-5xl lg:text-6xl">
                            Clean, modern coffee discovery with the calm of a
                            premium product page.
                        </h1>
                        <p className="mt-6 max-w-2xl text-base leading-8 text-stone-600">
                            Browse expressive origins, polished tasting
                            profiles, and a catalog designed with clarity,
                            restraint, and generous spacing.
                        </p>
                        {isAdmin ? (
                    ...
                    <Surface className="rounded-4xl p-8" variant="dark">
                        ...
                        <p className="mt-6 text-sm leading-7 text-stone-300">
                            Built for browsing first, with fast paths into
                            deeper tasting notes and an uncluttered admin
                            workflow.
                        </p>
                    </Surface>
                </div>
